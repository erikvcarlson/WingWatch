...
def montecarlo_intersection(station_data:list,test:bool=0):
    """
    Args:
        station_data: list; A list of nested lists containing the data for each station
    ...
    returns:
    points: numpy.array: The array of points generated by the monte carlo approximation 
    index_map: list: The list of indicies where the point lives in the overlap of each of the shells
    station_shells: numpy.array: an array of arrays which contain the verticies of the hulls of the antennas at the recieved signal strength
